const  Login = (props) => {
    return(
        <div>
            {props.text}
<section class="h-full gradient-form md:h-screen ml-20">
      ...
      <div class="xl:w-10/12">
        <div class="block bg-white shadow-lg rounded-lg">
          <div class="lg:flex lg:flex-wrap g-0">
            ...
            <div
              class="lg:w-6/12 flex items-center lg:rounded-r-lg rounded-b-lg lg:rounded-bl-none bg-red-600"
            >
              {/* <div class="text-white px-4 py-6 md:p-12 md:mx-6 bg-red-600">
